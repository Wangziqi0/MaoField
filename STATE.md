...
| git HEAD | `5505805` (5 道 gate verdict + C 证据库 + 复算脚本; D618 全 push origin/main, private 仓医疗 PII)。实时 HEAD 以 `git log -1` 为准 |
