...
| **GPT deep-research 报告 ★** | `docs/infra/gpt_deep_research/` = 四份 GPT/PRO claim-source + adoption note; report(3)=mean-null vector-field / LOSO-rank kill-test proposed audit; report(4)=external math-framework gate audit, repo facts blocked for auditor; 均需回查 code/log/verdict/JSON |
