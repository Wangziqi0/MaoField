...
\title{Finite Projection Order Defects in Residual Metric Audits}
\author{Author list to be fixed by the human PI}
\affil{MaoField research programme; local draft candidate under lock}
\date{3 July 2026}
...
This note makes three bounded contributions:
