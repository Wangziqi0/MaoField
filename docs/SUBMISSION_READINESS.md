...
## Author decisions adopted

| Field | Adopted value |
|---|---|
| Author | Yifan Chen; independent sole author |
| Affiliation | Independent Researcher, Luan, China |
| Corresponding email | 1426704936@qq.com |
| ORCID | 0009-0008-8344-1149 |
| Review model | Single-anonymized |
| Code licence | Apache-2.0 |
| Original data/docs/preprint licence | CC BY 4.0 |
| Controlled access | Evidence partition adopted; complete requests answered within 14 business days |
| Funding/APC support/competing interests/related manuscripts/prior NMI contact | None declared |
